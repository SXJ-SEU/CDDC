...
class ImageNetA(DatasetBase):
    ...
    dataset_dir = "/home/sxj/data/imagenet-adversarial"
    ...
    def read_data(self, classnames):
        ...
        folders = [
            f for f in listdir_nohidden(image_dir, sort=True)
            if os.path.isdir(os.path.join(image_dir, f)) and f not in TO_BE_IGNORED
        ]
        items = []
